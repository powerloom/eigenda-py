...
from eigenda.grpc.retriever import retriever_pb2 as retriever_dot_retriever__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f" but the generated code in retriever/retriever_pb2_grpc.py depends on"
...
class RetrieverStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RetrieveBlob = channel.unary_unary(
            "/retriever.Retriever/RetrieveBlob",
            request_serializer=retriever_dot_retriever__pb2.BlobRequest.SerializeToString,
            response_deserializer=retriever_dot_retriever__pb2.BlobReply.FromString,
...
def add_RetrieverServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "RetrieveBlob": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=retriever_dot_retriever__pb2.BlobRequest.FromString,
            response_serializer=retriever_dot_retriever__pb2.BlobReply.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        "retriever.Retriever", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("retriever.Retriever", rpc_method_handlers)
...
class Retriever(object):
    ...
    def RetrieveBlob(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/retriever.Retriever/RetrieveBlob",
            retriever_dot_retriever__pb2.BlobRequest.SerializeToString,
            retriever_dot_retriever__pb2.BlobReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
