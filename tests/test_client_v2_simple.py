...
class TestDisperserClientV2Simple:
    ...
    def test_parse_blob_status_all_cases(self, client):
        ...
        assert client._parse_blob_status(1) == BlobStatus.PROCESSING  # QUEUED -> PROCESSING
        assert client._parse_blob_status(2) == BlobStatus.GATHERING_SIGNATURES  # ENCODED -> GATHERING_SIGNATURES
        assert client._parse_blob_status(3) == BlobStatus.COMPLETE  # GATHERING_SIGNATURES -> COMPLETE
        assert client._parse_blob_status(4) == BlobStatus.FAILED  # COMPLETE -> FAILED 
        assert client._parse_blob_status(5) == BlobStatus.INSUFFICIENT_SIGNATURES  # FAILED -> INSUFFICIENT_SIGNATURES
    ...
    def test_get_blob_commitment_lines_193_207(self, mock_stub_class, client):
        ...
        mock_commitment.length_proof = b'test_length_proof'
