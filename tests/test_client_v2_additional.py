...
class TestDisperserClientV2Additional:
    ...
    @patch('eigenda.client_v2.disperser_v2_pb2_grpc.DisperserStub')
    def test_disperse_blob_complete_flow(self, mock_stub_class, mock_disperser_pb2, mock_common_pb2, client):
        ...
        mock_commitment.length_proof = b'length_proof'
        mock_commitment.length = 100
    ...
    @patch('eigenda.client_v2.disperser_v2_pb2')
    @patch('eigenda.client_v2.disperser_v2_pb2_grpc.DisperserStub')
    def test_disperse_blob_grpc_error(self, mock_stub_class, mock_disperser_pb2, mock_common_pb2, client):
