...
class MockRetrieverServicer(retriever_v2_pb2_grpc.RetrieverServicer):
    ...
    def RetrieveBlob(self, request, context):
        ...
        if hasattr(request.blob_header, 'commitment') and hasattr(request.blob_header.commitment, 'length'):
        ...
        if 0 <= blob_index < len(self.blob_data):
            ...
            context.set_details(f'Blob not found')
...
class TestRetrieverIntegration:
    ...
    def test_retrieve_multiple_blobs(self, grpc_server, mock_servicer):
        ...
        try:
            ...
            blob_keys = [b'test_blob_key_1', b'test_blob_key_2', b'test_blob_key_3']
            retrieved_data = []
    ...
    def test_concurrent_retrieval(self, grpc_server, mock_servicer):
        ...
        try:
            ...
            blob_configs = [(13, b'Hello, World!'), (19, b'This is a test blob'), (1000, b'x' * 1000)]
