...
class TestBlobKey:
    ...
    def test_blob_key_repr(self):
        ...
        data = b"\xff" * 32
        key = BlobKey(data)
        assert repr(key) == f"BlobKey({'f' * 64})"
...
class TestBlobHeader:
    ...
    def test_blob_header_complete_flow(self):
        ...
        g2_commitment1 = G2Commitment(
            x_a0=b"a" * 32, x_a1=b"b" * 32, y_a0=b"c" * 32, y_a1=b"d" * 32
        )
        g2_commitment2 = G2Commitment(x_a0=b"e" * 32, x_a1=b"" * 32, y_a0=b"g" * 32, y_a1=b"h" * 32)
        ...
        payment_metadata = PaymentMetadata(
            account_id="0x1234567890123456789012345678901234567890", cumulative_payment=12345
        )
    ...
    def test_blob_header_different_inputs_produce_different_keys(self):
        ...
        # Base components
        g1_commitment = G1Commitment(x=b"x" * 32, y=b"y" * 32)
        g2_commitment = G2Commitment(x_a0=b"a" * 32, x_a1=b"b" * 32, y_a0=b"c" * 32, y_a1=b"d" * 32)
