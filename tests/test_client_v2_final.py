...
class TestDisperserClientV2Final:
    ...
    def test_disperse_blob_full_flow_to_cover_lines_128_153(self, mock_common_pb2, mock_disperser_pb2, mock_stub_class, client):
    ...
    @patch('eigenda.client_v2.disperser_v2_pb2')
    @patch('eigenda.client_v2.common_v2_pb2')
    def test_disperse_blob_grpc_error_line_152_153(self, mock_common_pb2, mock_disperser_pb2, mock_stub_class, client):
