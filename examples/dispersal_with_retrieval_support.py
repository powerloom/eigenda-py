...
def save_blob_metadata(blob_key: BlobKey, blob_header: Any, reference_block: int, quorum_id: int = 0):
    ...
    metadata = {
        ...
        'blob_header_info': {
            ...
            'quorum_numbers': list(blob_header.quorum_numbers) if hasattr(blob_header, 'quorum_numbers') else [0]
        }
    }
...
def main():
    ...
    try:
        ...
        if status == BlobStatus.PROCESSING:
            print(f"✅ Blob dispersed successfully!")
